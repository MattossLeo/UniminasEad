<?php
require_once  get_template_directory() . "/inc/lib/maxipago/ResponseBase.php";
require_once  get_template_directory() . "/inc/lib/maxipago/RequestBase.php";
require_once  get_template_directory() . "/inc/lib/maxipago/Request.php";
